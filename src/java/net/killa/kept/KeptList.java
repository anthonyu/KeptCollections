...
public class KeptList<T> extends KeptCollection<T> implements List<T>, Synchronizable {
			...
			synchronized (this.elements) {
				try {
					...
					for (String s : children) {
						...
						this.elements.add((T) Transformer.bytesToObject(this.keeper.getData(this.znode + '/' + s, this.watcher, null)));
					}
	...
	public T remove(int index) {
		synchronized (this.elements) {
			...
			try {
				T previous = (T) Transformer.bytesToObject(this.keeper.getData(this.indices.get(index), false, null));
	...
	public T set(int index, T element) {
		...
		try {
			...
			T previous = (T) Transformer.bytesToObject(this.keeper.getData(path, false, null));
